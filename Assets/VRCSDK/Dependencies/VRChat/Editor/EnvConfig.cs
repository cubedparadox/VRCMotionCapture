...
public class EnvConfig
{
    ...
    static System.Collections.Generic.Dictionary<BuildTarget, UnityEngine.Rendering.GraphicsDeviceType[]> allowedGraphicsAPIs = new System.Collections.Generic.Dictionary<BuildTarget, UnityEngine.Rendering.GraphicsDeviceType[]>()
    {
        ...
        { BuildTarget.StandaloneWindows, new UnityEngine.Rendering.GraphicsDeviceType[] { UnityEngine.Rendering.GraphicsDeviceType.Direct3D11, UnityEngine.Rendering.GraphicsDeviceType.Direct3D9 } },
        { BuildTarget.StandaloneWindows64, new UnityEngine.Rendering.GraphicsDeviceType[] { UnityEngine.Rendering.GraphicsDeviceType.Direct3D11, UnityEngine.Rendering.GraphicsDeviceType.Direct3D9 } },
    ...
    public static void ConfigurePlayerSettings()
	{
		...
		SetVRSDKs(new string[] { "OpenVR", "Oculus" });
#endif
    }
	...
	static void RefreshClientVRSDKs()
	{
		...
		SetVRSDKs(new string[] { "OpenVR", "Oculus" });
#else
		SetVRSDKs(new string[] { "Oculus", "OpenVR" });
#endif
